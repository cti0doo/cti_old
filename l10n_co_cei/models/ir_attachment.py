...
class IrAttachment(models.Model):
    ...
    def create(self, values):
        if (not 'datas_fname' in values) and ('res_model' in values and values['res_model'] == 'l10n_co_cei.fe_archivos_email'):
            ...
            values['datas_fname'] = str(archivos['nombre_archivo_envio']) + '.' + extencion
